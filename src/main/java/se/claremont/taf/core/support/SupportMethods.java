...
public class SupportMethods {
    ...
    public static String getFileContent(String filePath){
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            System.out.println( "Could not read content of file '" + filePath + "'. It does not seem to be found." + fnfe.toString() );
        } catch (IOException ioe) {
            System.out.println( "Could not get file content from file '" + filePath + "'. " + ioe.getMessage() );
        }
        return fileContent;
    }
